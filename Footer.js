...
<footer class="vlt-footer vlt-footer--widgetized vlt-footer--fixed" >
			<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-4 offset-lg-1">
							...
							<div class="vlt-widget vlt-widget--white vlt-widget-nav-menu">
								<h4 class="vlt-widget__title vlt-widget__title--white" data-i18n="footer.links.title">快速鏈結</h4>
								<ul class="menu">
									<li><a href="index.html" data-i18n="footer.links.home">首頁</a></li>
									<li><a href="team.html" data-i18n="nav.team">博士團隊</a></li>
									<!-- <li><a href="#">成人課程</a></li> -->
									<li><a href="curriculum.html" data-i18n="footer.links.courses">線上、實體、到校及公開課程</a></li>
						...
						<div class="col-lg-3">
							...
							<div class="vlt-widget vlt-widget--white vlt-widget-subscribe">
								<h4 class="vlt-widget__title vlt-widget__title--white" data-i18n="footer.contact.title">聯絡我們</h4>
								<span data-i18n-html="footer.contact.address.hk">辦公地址（香港）：<br> 香港島堅尼地城士美菲路12號祥興大廈8樓</span><br>
								<span data-i18n-html="footer.contact.address.sg">辦公地址（新加坡）需預約： <br>71 Ayer Rajah Crescent, #02-01, Singapore 139951</span><br><br>	

								<a href="https://api.whatsapp.com/send?phone=9721314&text=%E6%88%91%E6%83%B3%E6%9F%A5%E8%A9%A2%E6%9C%89%E9%97%9CBioX%20%E7%9A%84STEM%20/%E6%B7%B1%E7%A7%91%E6%8A%80%E8%AA%B2%E7%A8%8B%E3%80%82" target="_blank">
									<span data-i18n-html="footer.contact.phone">聯絡電話/Whatsapp: <br> (+852) 9721-1314</span> 	
								</a>
				...
				<div class="vlt-footer-copyright">
					<p>&copy; ${new Date().getFullYear()} <span data-i18n="footer.copyright">BioX Limited. All rights reserved.</span></p>
				</div>
			</div>
		</footer>
